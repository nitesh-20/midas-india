...
const HeroSection = () => {
  return (
    <div>
        <section className="py-24 bg-grey-800">
  <div className="container flex items-center">
    ...
    <div className="flex-1">
      <div className="max-w-lg mx-auto">
        ...
        Looking to improve your coding skills or start your journey in programming? I offer personalized coaching sessions to help you achieve your coding goals. Whether you're a beginner or an experienced coder, We are here to guide you through the process.
        </p>
